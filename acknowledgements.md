...
description: Where this class comes from, and what it is built on.
nav_order: 9
---
...
Assignment 1 was adapted from an assignment created by Jonathan Zong and Janet Zong York in their course "AI, Justice, Imagination: Technology and Speculative Fiction."

The class draws heavily on materials and examples found online, and I try my best to give credit by linking to the original source. Please contact me (crystall `at` mit `dot` edu) if you find materials where credit is missing, or that you would rather have removed.